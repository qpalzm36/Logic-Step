...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/resultsmath/inference_log_math500_qwen7b.jsonl"  # 修改为MATH-500的推理结果路径
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/resultsmath/evaluation_report_math500qwen7b.json"  # 修改评估报告路径
...
def main():
    ...
    if not os.path.exists(INFERENCE_LOG_PATH):
        print(f"错误: 在 {INFERENCE_LOG_PATH} 找不到推理日志文件")
        return
    ...
    print(f"\n详细报告已保存至: {EVALUATION_REPORT_PATH}")
