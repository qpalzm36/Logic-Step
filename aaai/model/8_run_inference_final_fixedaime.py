...
# --- 配置 ---
GENERATOR_MODEL_PATH = "/data/yangcheng/aaai/generator_finetuned/Qwen-2.5-3B-Instruct" # <--- 修正这里的路径
RETRIEVER_MODEL_PATH = "/data/yangcheng/aaai/retriever_finetuned"
...
TEST_SET_PATH = "/data/yangcheng/AIME/AIME_2020_2024_filtered.jsonl"  # 修改为新的测试集路径
OUTPUT_LOG_PATH = "/data/yangcheng/aaai/resultsaime/inference_log_aimeqwen3B.jsonl"  # 修改输出路径

os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # 使用GPU 0和1
MAX_NEW_TOKENS = 512  
MAX_STEPS = 12        
