...
# --- 配置 ---
GENERATOR_MODEL_PATH = "/data/yangcheng/aaai/generator_finetuned/Meta-Llama-3-8B-Instruct"
...
TEST_SET_PATH = "/data/yangcheng/AIME/AIME_2020_2024_filtered.jsonl"
OUTPUT_LOG_PATH = "/data/yangcheng/aaai/resultsaime/inference_log_vllm_llama3_8B_aime.jsonl"

os.environ["CUDA_VISIBLE_DEVICES"] = "2"  # 使用GPU 0和1
MAX_NEW_TOKENS = 512
MAX_STEPS = 12
