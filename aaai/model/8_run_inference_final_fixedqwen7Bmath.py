...
TEST_SET_PATH = "/data/yangcheng/MATH-500/test.jsonl"  # 修改为MATH-500测试集路径
OUTPUT_LOG_PATH = "/data/yangcheng/aaai/resultsmath/inference_log_math500_qwen7b.jsonl"  # 修改输出路径
