...
# --- 配置 ---
GENERATOR_MODEL_PATH = "/data/yangcheng/aaai/generator_finetuned/Qwen-2.5-3B-Instruct"
...
TEST_SET_PATH = "/data/yangcheng/MATH-500/test.jsonl"  # 修改为新的测试集路径
OUTPUT_LOG_PATH = "/data/yangcheng/aaai/resultsmath/inference_log_vllm_math500.jsonl"  # 修改输出路径
