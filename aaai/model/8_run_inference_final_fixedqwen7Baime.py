...
# --- 配置 ---
GENERATOR_MODEL_PATH = "/data/yangcheng/aaai/generator_finetuned/Qwen2.5-Math-7B-Instruct"
...
TEST_SET_PATH = "/data/yangcheng/AIME/AIME_2020_2024_filtered.jsonl"  # 修改为AIME数据集路径
OUTPUT_LOG_PATH = "/data/yangcheng/aaai/resultsaime/inference_log_aimeqwen7b.jsonl"
