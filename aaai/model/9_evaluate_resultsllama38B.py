...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/results/inference_log_vllm_llama3.jsonl"
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/results/evaluation_report_llama3.json"
