...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/resultsmath/inference_log_vllm_math500.jsonl"  # 修改为新的推理结果路径
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/resultsmath/evaluation_report_math500qwen3B.json"  # 修改为新的评估报告路径
