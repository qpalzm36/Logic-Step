...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/resultsmath/inference_log_vllm_llama2_math500.jsonl"  # 修改为新的推理结果路径
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/resultsmath/evaluation_report_math500llama2.json"  # 修改评估报告路径
