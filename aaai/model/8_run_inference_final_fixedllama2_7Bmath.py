...
# --- 配置 ---
GENERATOR_MODEL_PATH = "/data/yangcheng/aaai/generator_finetuned/Llama-2-7b-chat-hf"
...
OUTPUT_LOG_PATH = "/data/yangcheng/aaai/resultsmath/inference_log_vllm_llama2_math500.jsonl"  # 修改输出路径
