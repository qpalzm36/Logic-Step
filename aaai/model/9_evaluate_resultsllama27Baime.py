...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/resultsaime/inference_log_aime_llama2.jsonl"
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/resultsaime/evaluation_report_aimellama2.json"
