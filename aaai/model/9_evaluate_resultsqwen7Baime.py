...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/resultsaime/inference_log_aimeqwen7b.jsonl"
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/resultsaime/evaluation_report_aimeqwen7b.json"
