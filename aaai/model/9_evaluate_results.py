...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/results/inference_log_vllm_2stage_final_fixed_new_8.jsonl"
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/results/evaluation_report_8.json"
