...
# 文件路径
INFERENCE_LOG_PATH = "/data/yangcheng/aaai/resultsaime/inference_log_aimeqwen3B.jsonl"
EVALUATION_REPORT_PATH = "/data/yangcheng/aaai/resultsaime/evaluation_report_aimeqwen3B.json"
